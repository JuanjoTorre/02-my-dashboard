...
// Forma de generar de forma dinamica la metadata
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	try {
		...
		return {
			...
			description:
				"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum aspernatur optio cum, vero expedita sed earum! Maiores ipsam quos voluptatibus vel, dolore ad earum iusto sint deleniti aliquam eum! Unde.",
		};
	}
}
